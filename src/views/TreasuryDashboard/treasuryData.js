...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all CST staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing CST.",
  ...
  staked: "CST Staked, is the ratio of sPID to CST (staked vs unstaked)",
